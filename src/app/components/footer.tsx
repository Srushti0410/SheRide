...
export function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#6A0DAD] to-[#4A0880] text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-white rounded-2xl flex items-center justify-center">
                <span className="text-[#6A0DAD] text-xl font-bold">S</span>
              </div>
        ...
        <div className="border-t border-white/20 pt-6 text-center text-purple-200">
